...
import { updateRestaurant as apiUpdateRestaurant } from '../services/api';
...
export const UpdateRestaurant: React.FC<UpdateRestaurantProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      onSuccess('Restaurant updated successfully.');
      onCancel();
    } catch (err: any) {
  ...
  return (
    <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
      <div className="bg-gradient-to-r from-red-600 via-orange-500 to-amber-500 px-8 py-8 text-white">
        <h1 className="text-3xl font-black">Edit Restaurant Profile</h1>
