        ...
        <div className="flex items-center gap-1 sm:gap-2">
          {user?.role !== 'seller' && (
            <>
              ...
              <Link
                to="/orders"
                className="hidden sm:flex items-center gap-1.5 px-3 py-2 text-sm text-gray-600 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all font-medium"
              >
